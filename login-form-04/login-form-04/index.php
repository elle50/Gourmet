          ...
          <div class="col-md-12">
            <div class="form-block mx-auto">
              <div class="text-center mb-5">
                <h3>Login to <strong>Gourmet</strong></h3>
              ...
              <form id="loginForm" name="loginForm" action="" method="POST">
                ...
                //     if ($account=$user_obj->login($_POST['form']['username'], $_POST['form']['password'])) {
                //       $_SESSION['account'] = $account;
                //       header("Location: ../../../Gourmet/index.html");
                //     } else {
                //       $errorMessage = "The login attempt failed";
                //     } 
                //   } else {
                ...
                <input type="submit" id="login" name="login" value="login" class="btn btn-block btn-primary">
